...
Future<void> loadTasks() async {
  ...
  setState(() {
    toDoList.removeAt(index); // Elimina la tarea de la lista local
    firestoreService.saveList(toDoList); // Actualiza la lista en Firebase después de eliminar la tarea
  });
}
...
Future<void> _editTask(int index) async {
  ...
  if (shouldUpdate == true) {
    setState(() {
      toDoList[index].nombreTarea = editController.text; // Actualiza la lista local
      firestoreService.saveList(toDoList); // Guarda la lista actualizada en Firebase
    });
  }
}
